...
## 2026-08-19 (tidy-up) — Test data purged, all offerings deactivated, registry corrected
...
- **Skate Jam deactivated.** All four offerings now `active=false`. The smoke-test booking it existed for has been confirmed, so it had served its purpose.
